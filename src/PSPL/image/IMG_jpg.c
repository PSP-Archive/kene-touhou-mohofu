...
#include "./../../jpeg/jpeglib.h"//#include "./../../jpeg/jpeglib.h"//#include <jpeglib.h>
...
//[廃止]	src->pub.in it_source		= in it_source; 	//(jpeg展開前処理用コールバック)
	...
	src->pub.skip_input_data	= /*[とりあえず]*/(void *)skip_input_data;
...
SDL_Surface *IMG_LoadJPG_RW(SDL_RWops *src)
{
	...
	//	#else
	//	0xff0000, 0x00ff00, 0x0000ff,//not_psp
	//	#endif
		0);
	if (surface == NULL)
	{
