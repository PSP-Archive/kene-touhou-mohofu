...
//typedef struct PSPL_AUDIO_DEVICE PSPL_AUDIO_DEVICE;
...
//#define _THIS	PSPL_AUDIO_DEVICE *_this
...
typedef struct //PSPL_AUDIO_DEVICE
{
	/* --- */
...
//	const char *desc;
//	int (*available)(void);
//	PSPL_AUDIO_DEVICE *(*create)(int devindex);
//} AudioBootStrap;
...
extern PSPL_AUDIO_DEVICE *current_audio;
