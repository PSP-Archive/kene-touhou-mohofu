...
//
	/* --- 半透明合成値 */
		...
		/*ARGB4444*/
//	u16 blendlevel = (((spr->alpha & 0xf0) << 8) | 0x0fff);
//	u16 blendlevel = ((( 0xf0) << 8) | 0x0fff);
	u16 blendlevel = (((cg.conv_bg_alpha &	0xf0) << 8) | 0x0fff);
// (cg.conv_bg_alpha)
		#else
//	u32 blendlevel = (((spr->alpha & 0xff) << 24) | 0x00ffffff);
	u32 blendlevel = (((cg.conv_bg_alpha & 0xff) << 24) | 0x00ffffff);
		#endif
	#endif
...
/* 何故か 1[pixel]ずれる(?) もしかして Y 座標 0 からじゃなくて 1 から？？ */
#define ND_ADD1 (1)
