...
/*static*/extern	u32 __attribute__((aligned(16))) gulist[PACKET_SIZE];
...
//	TEX_08_SCORE_PANEL, 		/* [TEX_07_FRONTと融合する可能性が高い(256x512テクスチャ？)] スコアパネル/スコアフォント文字 */
	TEX_09_TACHIE_L,			/* 立ち絵L プレイヤー */
	TEX_10_TACHIE_R,			/* 立ち絵R ボス(1人目) */
	#if (1==USE_VS3)
	TEX_11_TACHIE_RB,			/* 立ち絵 ボス(2人目) */
	TEX_12_TACHIE_RC,			/* 立ち絵 ボス(3人目) */
	#endif
