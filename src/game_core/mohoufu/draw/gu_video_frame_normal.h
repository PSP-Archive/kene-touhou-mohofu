...
//extern void psp_video_flip_screen(int vsync)
#if 0
	...
	/*	}*/\
		cg.show_frame = cg.draw_frame;\
		cg.draw_frame = sceGuSwapBuffers();\
	}
#else
...
// 初期化状態と同じ。	sceGuDrawBufferList(SDL_GU_PSM_0000/*GU_PSM_5551*/ /*4444*/, cg.draw_frame/*dst*/, PSP_BUFFER_WIDTH512);
...
//	/* 火炎爆発(フロント面エフェクト) */
	...
	//	s_blit_all_objects();/*PRIORITY_06_FRONT*/
		...
		*/
		if (shooting_game_core_work == cg.main_call_func)/* game_coreの場合のみ 描画 */
		{
