...
/* 指定行を1行消す。 */
extern void kanji_window_clear_line(u32 line_num);
...
*/
// 仮想バッファのレンダリング位置を指定。
extern void set_kanji_xy(u32 set_x_offset_pixel, u32 set_y_offset_pixel);
// 画面表示の基準位置仮想を指定。
...
extern void set_kanji_hide_line(int line_num);
#endif
