...
//1 小丸弾(グループ弾)
	...
	BULLET_MARU10_01_, // 赤[直接使わない]
	BULLET_MARU10_02_, // 紫[直接使わない]
	BULLET_MARU10_03_, // 青[直接使わない]
	BULLET_MARU10_04_, // 水[直接使わない]
	BULLET_MARU10_05_, // 緑[直接使わない]
	BULLET_MARU10_06_, // 黄[直接使わない]
	BULLET_MARU10_07_, // 橙[直接使わない]
//2 米弾(グループ弾)
	BULLET_KOME_BASE, // 白 米弾(グループ弾)
	BULLET_KOME_01_, // 赤[直接使わない]
	BULLET_KOME_02_, // 紫[直接使わない]
	BULLET_KOME_03_, // 青[直接使わない]
	BULLET_KOME_04_, // 水[直接使わない]
	BULLET_KOME_05_, // 緑[直接使わない]
	BULLET_KOME_06_, // 黄[直接使わない]
	BULLET_KOME_07_, // 橙[直接使わない]
//3 ミニ弾(グループ弾) size: 08x08[pixel]
	BULLET_MINI8_BASE, // 白 ミニ弾(グループ弾)
	BULLET_MINI8_01_, // 赤[直接使わない]
	BULLET_MINI8_02_, // 紫[直接使わない]
	BULLET_MINI8_03_, // 青[直接使わない]
	BULLET_MINI8_04_, // 水[直接使わない]
	BULLET_MINI8_05_, // 緑[直接使わない]
	BULLET_MINI8_06_, // 黄[直接使わない]
	BULLET_MINI8_07_, // 橙[直接使わない]
//4 枠付き中丸弾(グループ弾) size: 12x12[pixel]
	BULLET_WAKU12_BASE, // 白 枠付き中丸弾(グループ弾)	[チルノ]
	BULLET_WAKU12_01_, // 赤[直接使わない]	[チルノ]
	BULLET_WAKU12_02_, // 紫[直接使わない]	KURO_AKA,		// [紫] /*12*/	レミリア用の黒枠赤弾			//	BULLET_CAP16_04_KOME_SIROI, 	/* [青白米弾] */
	BULLET_WAKU12_03_, // 青[直接使わない]	[チルノ]
	BULLET_WAKU12_04_, // 水[直接使わない]	// (r35) BULLET_CAP16_04_TUTU_SIROI,	// [水] /*12*/						/* [青白実包弾] */
	BULLET_WAKU12_05_, // 緑[直接使わない]	[チルノ]
	BULLET_WAKU12_06_, // 黄[直接使わない]	[チルノ]	//	BULLET_MINI8_12_dummy,
	BULLET_WAKU12_07_, // 橙[直接使わない]	[チルノ]	//	BULLET_MINI8_13_dummy,
//5 ふぐちり弾(鱗弾) (グループ弾)
	BULLET_UROKO14_BASE, // 白 ふぐちり弾(鱗弾) (グループ弾)
	BULLET_UROKO14_01_, // 赤[直接使わない]
	BULLET_UROKO14_02_, // 紫[直接使わない]
	BULLET_UROKO14_03_, // 青[直接使わない]
	BULLET_UROKO14_04_, // 水[直接使わない]
	BULLET_UROKO14_05_, // 緑[直接使わない]
	BULLET_UROKO14_06_, // 黄[直接使わない]
	BULLET_UROKO14_07_, // 橙[直接使わない]
//6 クナイ弾(グループ弾)
	BULLET_KUNAI12_BASE, // 白 クナイ弾(グループ弾)
	BULLET_KUNAI12_01_, // 赤[直接使わない]
	BULLET_KUNAI12_02_, // 紫[直接使わない]
	BULLET_KUNAI12_03_, // 青[直接使わない]
	BULLET_KUNAI12_04_, // 水[直接使わない]
	BULLET_KUNAI12_05_, // 緑[直接使わない]
	BULLET_KUNAI12_06_, // 黄[直接使わない]
	BULLET_KUNAI12_07_, // 橙[直接使わない]
//7 札弾 / ナイフ弾
...
//	/* 火炎爆発(フロント面エフェクト) */
	...
	BAKUHA09,	/* 火炎爆発 */
	BAKUHA0a,	/* 火炎爆発 */
	TITLE_LOGO_01, //BAKUHA0b,	/* 東 火炎爆発 */
	TITLE_LOGO_02, //BAKUHA0c,	/* 方 火炎爆発 */
	TITLE_LOGO_03, //BAKUHA0d,	/* 模 火炎爆発 */
	TITLE_LOGO_04, //BAKUHA0e,	/* 倣 火炎爆発 */
	TITLE_LOGO_05, //BAKUHA0f,	/* 風 火炎爆発 */
//0x20
	SPELL_SQUERE_,	/* [□] x 5 */
	PANEL_STR_EXTRA, //
