 ...
 *   set scissoring area (x0, y0)-(x1, y1) in pixels.
 *
 * Note that scissoring is only performed if the custom scissoring is enabled (GU_SCISSOR_TEST)
 *
 * @param x0 - Left of scissor region
 * @param y0 - Top of scissor region
 * @param x1 - Right of scissor region
 * @param y1 - Bottom of scissor region
**/
